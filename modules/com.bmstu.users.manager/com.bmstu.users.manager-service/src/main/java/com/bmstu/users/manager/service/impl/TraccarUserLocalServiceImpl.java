...
public class TraccarUserLocalServiceImpl extends TraccarUserLocalServiceBaseImpl {
	...
	protected void validate(String name, String password, String email) throws PortalException {
		validateName(name);
	...
	protected void validateEmail(String email) throws PortalException {
